...
.header{ width:28%; display:flex; justify-content:space-between; background:transparent; color:var(--fg); border:none; font-size:14px; padding:6px 0; cursor:pointer }
